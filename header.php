...
<!--    preloader -->
  ...
  <div id="page" class="hfeed site <?php echo $titlebar_class; ?>">
      <div class="headerwrap">
	    <!-- Add Welcome Section -->
      <table width="100%" style="margin: 0px; border: none" class="weather-top-widget">
        <thead>
          <col width="0%">
          <col width="100%">
          <tr>
            ...
            <?php
            //echo do_shortcode('[awesome-weather location="Istanbul, TR" hide_stats="1" background_by_weather="1" units="C" forecast_days="0"]');
             ?>
             </td>
            <td style="text-align: center; padding: 0px;">
              <h4 style="text-align: center;">
                <?php _e('Payment by installments is available for orders exceeded 1000 SAR', 'ispirit') ?>
              </h4>
            </td>
          </tr>
        </thead>
