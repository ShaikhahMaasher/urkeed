...
<div class="wcmp_regi_main" id ="cairo_font">
    <form class="register" id="pending_vendor_regi_form[]" name="pending_vendor_regi_form[]" role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="wcmp_regi_form_box">
            ...
            <div class="wcmp-regi-12 ">
                ...
                <br/>
                <input class="half-ele" type="email" required="required"  name="email" id="reg_email" value="<?php if (!empty($_POST['email'])) echo esc_attr($_POST['email']); ?>" />
            </div>
