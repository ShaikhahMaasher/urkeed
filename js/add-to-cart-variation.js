...
;(function ( $, window, document, undefined ) {
	...
	VariationForm.prototype.onAddToCart = function( event ) {
		if ( $( this ).is('.disabled') ) {
			...
			if ( $( this ).is('.wc-variation-is-unavailable') ) {
				$("#choose_variation_msg").removeClass('hide-error-msg');
				// window.alert("Test un"); //wc_add_to_cart_variation_params.i18n_unavailable_text );
			} else if ( $( this ).is('.wc-variation-selection-needed') ) {
				$("#choose_variation_msg").removeClass('hide-error-msg');
				// window.alert( "Test select");//wc_add_to_cart_variation_params.i18n_make_a_selection_text );
			}
		}
	};
	...
	VariationForm.prototype.onChange = function( event ) {
		...
		if ( form.useAjax ) {
			...
			form.$form.trigger( 'check_variations' );
			$('#choose_variation_msg').addClass('hide-error-msg');
			$( this ).blur();
		}
