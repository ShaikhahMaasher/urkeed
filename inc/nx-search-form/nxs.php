...
class nxLiveSearch {
	...
	function get_templates($template, $type='')
	{
		...
		switch($type) {
			case 'more':
				$template_post = '<a href="{search_url_escaped}"><span class="sf_text">'. __('More results in here ','ispirit').'"{search_value}"</span><span class="sf_small">Displaying top {total} results</span></a>';
            break;
			case 'taxonomy':
